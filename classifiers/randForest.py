...
def run_ml(): # similar to perform_ML3(), compute featImp and confusion matrix foldbyfold added
    ...
    clf = RandomForestClassifier(n_estimators=600, max_depth=70, min_samples_leaf=4, min_samples_split=10, class_weight='balanced')
    ...
    res.to_csv('rndforest_metrics.csv')

    # write predictions to file
    feat_imp_df.to_csv('rndforest_feature_importance.csv', index=False)
    fold_pred.to_csv('rndforest_prediction.csv', index=False)
    print('Completed!')
