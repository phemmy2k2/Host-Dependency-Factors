...
def run_ml(): # similar to perform_ML3(), compute featImp and confusion matrix foldbyfold added
    ...
    clf = LogisticRegression(max_iter=10000, penalty='elasticnet',solver='saga', l1_ratio=0.5, n_jobs=3, class_weight='balanced')
    ...
    res.to_csv('logregression_metrics.csv')

    # write predictions to file
    fold_pred.to_csv('logregression_prediction.csv', index=False)
    print('Completed!')
